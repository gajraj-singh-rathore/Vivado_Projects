...
REM
REM Generated by Vivado on Fri Jun 12 16:51:39 +0530 2026
...
echo "xvhdl --incr --relax -prj mincounter_tb_vhdl.prj"
call xvhdl  --incr --relax -prj mincounter_tb_vhdl.prj -log xvhdl.log
