...
REM
REM Generated by Vivado on Mon Jun 08 19:14:17 +0530 2026
...
echo "xvhdl --incr --relax -prj barrShift1_tb_vhdl.prj"
call xvhdl  --incr --relax -prj barrShift1_tb_vhdl.prj -log xvhdl.log
